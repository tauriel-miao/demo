...
public class JdbcTest_NoAuthc_Druid {

    String driver = "org.elasticsearch.jdbc.api.ElasticDriver";
    //String elasticsearchAddress = "172.16.150.163:9300,172.16.150.168:9300";
    ...
    public void test() throws UnsupportedEncodingException {
        try {
            String address = "jdbc:elastic://" + elasticsearchAddress;
            Properties properties = new Properties();
            properties.put("url", address);
/*            properties.put("username", "admin");
            properties.put("password", "admin");*/
            System.setProperty("es.set.netty.runtime.available.processors", "false");
            DruidDataSource dds = (ElasticSearchDruidDataSource) ElasticSearchDruidDataSourceFactory.createDataSource(properties);
...
//                System.out.println(resultSet.getInt(4));
    ...
    public Settings getSettings() throws UnsupportedEncodingException {
        ClassLoader classLoader = JdbcTest_NoAuthc_Druid.class.getClassLoader();
