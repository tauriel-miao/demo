...
public class MyElasticSearchConnection extends ElasticSearchConnection {

    private Client client;

    public MyElasticSearchConnection(String jdbcUrl, Settings settings) {
        super(jdbcUrl);
        try {
            ...
            for (String hostAndPortAdmin : hostAndPortArray) {
                String hostAndPort = hostAndPortAdmin.split("@")[1];
