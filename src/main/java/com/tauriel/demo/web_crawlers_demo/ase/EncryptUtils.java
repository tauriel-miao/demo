...
public class EncryptUtils {
    ...
    public static Map<String, String> encrypt(String id) {
        // a()
        String secKey = RandomStringUtils.random(16, "0123456789abcde");
        System.out.println("secKey a() --> " + secKey);
        // b()
        String encText = aesEncrypt(aesEncrypt(id, nonce), secKey);
        System.out.println("encText b() --> " + encText);
        // c()
        String encSecKey = rsaEncrypt(secKey, pubKey, modulus);
        System.out.println("encSecKey c() --> " + encSecKey);
